...
<?php else: ?>
       ...
       <header class="site-header header-with-right-menu dark-mode-texts site-header--absolute fixed-header-layout"> 
                <div class="container-fluid pr-lg-9 pl-lg-9"> 
                    <!-- START navbar -->                     
                    <nav class="navbar site-navbar offcanvas-active navbar-expand-lg px-0 font_family_TKT">
                        <!-- START Logo header -->                         
                        <div class="brand-logo mr-8 font_family_TKT">
                        <?php
                        if(class_exists('ReduxFramework') and class_exists('Boostify_Header_Footer_Builder')){ ?> 
                        <!-- light version logo (logo must be black)-->
                        <a class="font_family_TKT" href="<?php echo esc_url(get_home_url()); ?>">
                        <img src="<?php echo $emyuiredux['opt29']['url']; ?>" alt="<?php get_bloginfo( 'name' ); ?>" class="light-version-logo"/>
                        <!-- Dark version logo (logo must be White)-->
                        <img src="<?php echo $emyuiredux['opt2']['url']; ?>" alt="<?php get_bloginfo( 'name' ); ?>" class="dark-version-logo"/> 
                        </a> 
                        <?php }else{ ?>
                         <!-- light version logo (logo must be black)-->
                         <a class="font_family_TKT" href="<?php echo esc_url(get_home_url()); ?>">
                        ...
                        <div class="collapse navbar-collapse" id="mobile-menu"> 
                            <div class="navbar-nav-wrapper nos font_family_TKT">
                                <?php
                                wp_nav_menu( array(
